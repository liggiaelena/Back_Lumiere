...
def parse_args():
    ...
    parser.add_argument("--dataset-dir", default="training/datasets/vitiligo/processed")
    parser.add_argument(
        "--checkpoint",
        default="training/checkpoints/SegFormer/segformer_b2_4class_vitiligo_finetune/best",
    )
    parser.add_argument(
        "--output-dir",
        default="training/checkpoints/SegFormer/segformer_b2_4class_vitiligo_finetune/evaluation",
    )
